...
|             | `MaxLength`          | 长度最大值                                   |
|             | `LengthRange`        | 长度范围                                    |
|             | `UTF8LengthIs`       | UTF8编码长度是                               |
|             | `UTF8LengthIsNot`    | UTF8编码长度不是                              |
...
|             | `MaxLength`           | 元素长度最大值                               |
|             | `LengthRange`         | 元素长度范围                                |
|             | `UTF8LengthIs`        | 元素的UTF-8编码长度等于                        |
|             | `UTF8LengthNotEquals` | 元素的UTF-8编码长度不等于                       |
|             | `MinUTF8Length`       | 元素的UTF-8编码长度最小值                       |
|             | `MaxUTF8Length`       | 元素的UTF-8编码长度最大值                       |
|             | `UTF8LengthRange`     | 元素的UTF-8编码长度范围                        |
|             | `IsLower`             | 是小写字母                                 |
|             | `IsUpper`             | 是大写字母                                 |
|             | `IsLetter`            | 是字母                                   |
|             | `IsLowerOrNumber`     | 是小写字母或数字                              |
...
|             | `IntSlice`           | 返回`[]int`类型的数值                         |
|             | `DefaultIntSlice`    | 返回`[]int`类型的数值，失败返回指定的值                |
|             | `Int8Slice`          | 返回`[]int8`类型的数值                        |
|             | `DefaultInt8Slice`   | 返回`[]int8`类型的数值，失败返回指定的值               |
|             | `Int16Slice`         | 返回`[]int16`类型的数值                       |
|             | `DefaultInt16Slice`  | 返回`[]int16`类型的数值，失败返回指定的值              |
|             | `Int32Slice`         | 返回`[]int32`类型的数值                       |
|             | `DefaultInt32Slice`  | 返回`[]int32`类型的数值，失败返回指定的值              |
|             | `Int64Slice`         | 返回`[]int64`类型的数值                       |
|             | `DefaultInt64Slice`  | 返回`[]int64`类型的数值，失败返回指定的值              |
|             | `UintSlice`          | 返回`[]uint`类型的数值                        |
|             | `DefaultUintSlice`   | 返回`[]uint`类型的数值，失败返回指定的值               |
|             | `Uint8Slice`         | 返回`[]uint8`类型的数值                       |
|             | `DefaultUint8Slice`  | 返回`[]uint8`类型的数值，失败返回指定的值              |
|             | `Uint16Slice`        | 返回`[]uint16`类型的数值                      |
|             | `DefaultUint16Slice` | 返回`[]uint16`类型的数值，失败返回指定的值             |
|             | `Uint32Slice`        | 返回`[]uint32`类型的数值                      |
|             | `DefaultUint32Slice` | 返回`[]uint32`类型的数值，失败返回指定的值             |
|             | `Uint64Slice`        | 返回`[]uint64`类型的数值                      |
|             | `DefaultUint64Slice` | 返回`[]uint64`类型的数值，失败返回指定的值             |
...
|             | `Float32Slice`        | 返回`[]float32`类型的数值                   |
|             | `DefaultFloat32Slice` | 返回`[]float32`类型的数值，失败返回指定的值          |
|             | `Float64Slice`        | 返回`[]float64`类型的数值                   |
|             | `DefaultFloat64Slice` | 返回`[]float64`类型的数值，失败返回指定的值          |
