...
func (obj *Object) AllowInts(i []int, customError ...string) *Object {
	if obj.err != nil || obj.rawValue == "" {
		return obj
	}
...
func (obj *Object) AllowInts32(i []int32, customError ...string) *Object {
	if obj.err != nil || obj.rawValue == "" {
		return obj
	}
...
func (obj *Object) AllowInts64(i []int64, customError ...string) *Object {
	if obj.err != nil || obj.rawValue == "" {
		return obj
	}
	if obj.i64 == 0 {
...
func (obj *Object) AllowFloats32(f []float32, customError ...string) *Object {
	if obj.err != nil || obj.rawValue == "" {
		return obj
	}
...
func (obj *Object) AllowInFloats64(f []float64, customError ...string) *Object {
	if obj.err != nil || obj.rawValue == "" {
		return obj
	}
	if obj.f64 == 0 {
